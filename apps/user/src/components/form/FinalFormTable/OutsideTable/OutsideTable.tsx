      ...
      <tbody>
        <Tr>
          ...
          >
            ...
            <br />
            <ul>
              <li>군사분계선 이북지역에서 9년 이상이 학교교육을 이수한 자</li>
            </ul>
        ...
        <Tr>
          ...
          >
            ...
            <li>외국 학교 전 학년 재학증명서(또는 졸업증명서) 1부</li>
            <li>
              국내 최종학교 재학(정원 외 관리, 재학 사실) 또는 졸업증명서 1부 <br />
              (최종 재학 학년 및 최종 재학 연월일이 명시되어 있어야 함)
            </li>
            <li>출입국 사실 증명서(학생, 부, 모 모두) 1부</li>
            <li>
              전 가족이 등재된 주민등록등본 1부 <br />
              (재외동포 자녀인 경우 ① 말소된 주민등록등본 1부 제출 또는 ② 국내 거소사실 증
              명서(또는 영주권 사본) 1부 제출)
            </li>
            <li>
              재외국민등록부 등본(학생, 부, 모, 모두) 1부 (재외국민 미등록 시 거주) 사실을
              증명할 수 있는 각종 문서 제출 필요
            </li>
          </Td>
        </Tr>
        <Tr>
          ...
          >
            ...
            <li>외국 학교 전 학년 재학증명서(또는 졸업증명서) 1부</li>
            <li>
              국내 최종학교 재학(정원 외 관리, 재학사실) 또는 졸업증명서 1부
              <br />
              (최종 재학 학년 및 최종 재학 연월일이 명시되어 있어야 함)
            </li>
            <li>출입국 사실 증명서(학생, 부, 모, 모두) 1부</li>
            <li>
              전 가족이 등재된 주민등록등본 1부 (재외동포 자녀인 경우 거소사실 증명,
              영주권(시민권) 사본 제출)
            </li>
        ...
        <Tr>
          ...
          >
            ...
            <li>외국 학교 전 학년 재학증명서(또는 졸업증명서) 1부</li>
            <li>
              국내 최종학교 재학(정원 외 관리, 재학사실) 또는 졸업증명서 1부 <br /> (최종
              재학 학년 및 최종 재학 연월일이 명시되어 있어야 함)
            </li>
            <li>출입국 사실 증명서(학생만 제출) 1부</li>
            <li>
              가족관계 증명서 1부 (부모 중 1인이 대한민국 국민인 경우 발급 가능(외국인의
              경우 국내거소사실증명서))
            </li>
            <li>
              외국인 등록사실 증명 1부 또는 외국인 등록증 사본 1부
              <br />
              (부모 모두 외국인인 경우: 부모와 학생 모두 제출, 부모 중 1인이 대한민국
              국민인 경우: 학생만 제출)
            </li>
          </Td>
        </Tr>
