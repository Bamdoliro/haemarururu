      ...
      <Column gap={100}>
        <Column gap={24}>
          ...
          <Text fontType="p3">
            ...
            사실에 입각하여 정직하게 자기주도학습과정, 건학이념과 연계한 지원동기, <br />
            꿈과 끼를 살리기 위한 활동계획 및 진로계획 그리고 생활기록부에 기록된 인성영역
            활동 실적과 이를 통해 배우고 느낀 점 등을 기술해주세요.
          </Text>
          ...
          <Text fontType="p3">
            2. 본문에는 자신의 경험이나 사례 등을 들어 구체적으로 작성하되, 영어 등 각종
            인증시험 점수, 교과목의 점수·석차, 교내‧외 각종 대회 입상실적, 자격증,
            <br />
            영재교육원 교육 및 수료 여부(우회적‧간접적 기재 포함) 등은 기재 시 0점
            처리되며, 부모의 사회·경제적 지위 암시 내용, 지원자 본인의 인적사항을 암시하는
            <br />
            내용 등은 기재 시 항목 배점의 10%이상 감점 처리되니 기재하지 말아주세요.{' '}
            <br />
            3. 반드시 본 서식을 사용하여 작성하고, 띄어쓰기를 제외한 영역별 제한된 글자수
            이내로 제시된 형식에 따라 작성해주세요.
            <br /> 4. 자기소개서를 입학원서와 함께 본교에 일괄 제출해주세요.
            <br />
            5. 자기소개서는 입학전형 및 입학 후 학생 지도 자료로 활용되며, 비공개 문서로
            관리될 예정입니다.
          </Text>
          <Text fontType="p3" color={color.red}>
            *자기소개서는 자동저장됩니다.
