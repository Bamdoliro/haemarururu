...
import ReceiveStatusChangeModal from '@/components/form/ReceiveStatusChangeModal/ReceiveStatusChangeModal';
...
const StatusManager = ({ id }: StatusManagerProps) => {
  ...
  const paymentAdmissionStatus = formDetailData?.payment;
